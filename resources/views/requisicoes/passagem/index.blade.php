...
@section('title', 'Requisições de Passagem')
    ...
    <div class="container py-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Passagens</li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <div class="container">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
                <h5 class="mb-0 text-primary fw-bold"><i class="fas fa-ticket-alt me-2"></i>Requisições de Passagem</h5>
                <a href="{{ route('requisicoes.passagem.create.novo') }}" class="btn btn-primary">
            ...
            <div class="card-body p-4">
                <div class="bg-light p-3 rounded mb-4 border">
                    <form id="filtrosForm" method="GET" action="{{ route('requisicoes.passagem.index') }}" class="row g-3 align-items-end">
                        ...
                        <div class="col-lg-1 col-md-4 d-flex gap-1">
                            ...
                            <a href="{{ route('requisicoes.passagem.index') }}" class="btn btn-outline-secondary flex-fill" title="Limpar">
                    ...
                    <table class="table table-hover align-middle">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-uppercase small fw-bold text-muted">Destino</th>
