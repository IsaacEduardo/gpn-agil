...
<head>
    ...
    @endphp
    <meta charset="UTF-8">
    <title>Termo de Entrega Definitiva</title>
    <style>
...
<body>
    <div class="header">
        ...
        <div class="title">TERMO DE ENTREGA DEFINITIVA</div>
    ...
    <div class="section">
        Ao assinar este termo, o beneficiário declara ter recebido de forma definitiva o(s) item(ns) acima descrito(s),
        assumindo plena responsabilidade pela guarda, uso e conservação, de acordo com as normas internas da
        instituição.
    </div>
