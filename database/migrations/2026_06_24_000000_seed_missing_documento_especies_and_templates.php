...
return new class extends Migration
{
    ...
    {
        // 1. Seed all document species
        $nomes = [
            'Ofício', 'Carta', 'Memorando', 'Circular', 'Despacho', 'Email', 'Relatório', 'Nota', 'Requerimento', 'Acta', 'Outro', 'Parecer', 'Guia de Marcha', 'Guia de Férias', 'Guia de Apresentação', 'Declaração de Vaga', 'Declaração de Salário', 'Mapa'
        ];

        foreach ($nomes as $i => $nome) {
            DB::table('documento_especies')->updateOrInsert(
                ['nome' => $nome],
                [
                    'ativo' => true,
                    'ordem' => $i + 1,
        ...
        // 2. Resolve admin user ID or fallback
        ...
        // 3. Define templates and associate with correct species
        $templates = [
            'Ofício' => [
    ...
    <div style="text-align: center;">
        ...
        {{DEPARTAMENTO_NOME}}
            ...
            'Despacho' => [
                ...
                'campos_dinamicos' => json_encode(['decisao' => 'select:Aprovado,Rejeitado,Arquivar', 'observacoes' => 'textarea']),
                'conteudo' => '
<div style="font-family: \'Times New Roman\', serif; font-size: 12pt; line-height: 1.5; color: #000;">
    ...
    <div style="text-align: center;">
        ...
        {{DEPARTAMENTO_NOME}}
            ...
            'Acta' => [
                ...
                'campos_dinamicos' => json_encode(['hora_inicio' => 'time', 'ordem_trabalhos' => 'textarea']),
                'conteudo' => '
    ...
    <div style="text-align: center;">
        ...
        <strong>{{USUARIO_NOME}}</strong>
            ...
            'Parecer' => [
                ...
                'campos_dinamicos' => json_encode(['processo_numero' => 'text', 'interessado' => 'text']),
                'conteudo' => '
<div style="font-family: \'Times New Roman\', serif; font-size: 12pt; line-height: 1.5; color: #000;">
    <p style="text-align: center; font-weight: bold; text-transform: uppercase;">
    ...
    <div style="text-align: center;">
        ...
        Jurista
            ...
            'Guia de Marcha' => [
                'nome' => 'Guia de Marcha',
                'campos_dinamicos' => json_encode(['destino' => 'text', 'motivo' => 'text', 'data_partida' => 'date', 'data_regresso' => 'date']),
                'conteudo' => '
<div style="font-family: \'Times New Roman\', serif; font-size: 12pt; line-height: 1.5; color: #000;">
    <p style="text-align: center; font-weight: bold; text-transform: uppercase;">
        GUIA DE MARCHA
    ...
    <div style="text-align: center;">
        ...
        <strong>{{RESPONSAVEL_NOME}}</strong>
            ...
            'Guia de Férias' => [
                'nome' => 'Guia de Férias',
                'campos_dinamicos' => json_encode(['ano_referente' => 'number', 'dias_gozo' => 'number', 'data_inicio' => 'date', 'data_fim' => 'date']),
                'conteudo' => '
<div style="font-family: \'Times New Roman\', serif; font-size: 12pt; line-height: 1.5; color: #000;">
    <p style="text-align: center; font-weight: bold; text-transform: uppercase;">
        GUIA DE FÉRIAS
    ...
    <div style="text-align: center;">
        ...
        <strong>{{RESPONSAVEL_NOME}}</strong>
            ...
            'Guia de Apresentação' => [
                ...
                'campos_dinamicos' => json_encode(['apresentado_nome' => 'text', 'motivo_apresentacao' => 'text']),
                'conteudo' => '
<div style="font-family: \'Times New Roman\', serif; font-size: 12pt; line-height: 1.5; color: #000;">
    <p style="text-align: center; font-weight: bold; text-transform: uppercase;">
        GUIA DE APRESENTAÇÃO
    ...
    <div style="text-align: center;">
        ...
        {{USUARIO_NOME}}
            ...
            'Declaração de Vaga' => [
                ...
                'campos_dinamicos' => json_encode(['categoria_funcional' => 'text']),
                'conteudo' => '
<div style="font-family: \'Times New Roman\', serif; font-size: 12pt; line-height: 1.5; color: #000;">
    <p style="text-align: center; font-weight: bold; text-transform: uppercase;">
        DECLARAÇÃO
    ...
    <div style="text-align: center;">
        ...
        <strong>{{RESPONSAVEL_NOME}}</strong>
            ...
            'Declaração de Salário' => [
                ...
                'campos_dinamicos' => json_encode(['salario_base' => 'number', 'subsidios' => 'number']),
                'conteudo' => '
<div style="font-family: \'Times New Roman\', serif; font-size: 12pt; line-height: 1.5; color: #000;">
    <p style="text-align: center; font-weight: bold; text-transform: uppercase;">
    ...
    <div style="text-align: center;">
        ...
        __________________________________
            ...
            'Mapa' => [
                ...
                'campos_dinamicos' => json_encode(['mes_referencia' => 'text']),
                'conteudo' => '
<div style="font-family: \'Times New Roman\', serif; font-size: 12pt; line-height: 1.5; color: #000;">
    <p style="text-align: center; font-weight: bold; text-transform: uppercase;">
    ...
    <div style="text-align: center;">
        ...
        foreach ($templates as $especieNome => $data) {
            // Find the species ID
            $especie = DB::table('documento_especies')->where('nome', $especieNome)->first();
            if ($especie) {
                // Check if template already exists
                $exists = DB::table('modelo_documentos')
                    ->where('nome', $data['nome'])
                    ->where('documento_especie_id', $especie->id)
        ...
        // 4. Flush the Laravel cache key so changes take effect immediately
    ...
    {
        // For safety, we do not delete lookup species that might be referenced by existing documents.
