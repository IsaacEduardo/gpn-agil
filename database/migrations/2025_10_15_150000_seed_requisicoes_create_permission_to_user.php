...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $perm = DB::table('permissions')->where('name', 'requisicoes.create')->first();
        if (! $perm) {
            DB::table('permissions')->insert([
                'name' => 'requisicoes.create',
                'description' => 'Pode criar requisições',
                'created_at' => now(),
                'updated_at' => now(),
            ]);
            $perm = DB::table('permissions')->where('name', 'requisicoes.create')->first();
    ...
    public function down(): void
    {
        ...
        DB::table('permissions')->where('name', 'requisicoes.create')->delete();
    }
};
